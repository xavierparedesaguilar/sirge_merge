...
Router::prefix('admin', function ($routes) {
    ...
    $routes->connect($bancoinvitro . 'importar', ['controller' => 'BankInvitro', 'action' => 'import']);
    $routes->connect($bancoinvitro . 'exportar', ['controller' => 'BankInvitro', 'action' => 'export']);/***RUTA PARA DESCARGAR PLANTILLA DE IMPORTACION ***/
    $routes->connect($bancoinvitro . 'cargar', ['controller' => 'BankInvitro', 'action' => 'uploadfile']);
    $routes->connect($bancoinvitro . 'exportacion', ['controller' => 'BankInvitro', 'action' => 'exportartabla']);
    ...
    $routes->connect($bancosemilla . 'importar', ['controller' => 'BankSeed', 'action' => 'import']);
    $routes->connect($bancoinvitro . 'exportarxls', ['controller' => 'BankSeed', 'action' => 'export']);/***RUTA PARA DESCARGAR PLANTILLA DE IMPORTACION ***/
    ...
    /****************** INICIO Modulo Fitogenetico ***********************/
        ...
        $routes->connect($fito_descriptor . ':idx/:idy/descriptor/exportacion', ['controller' => 'DescriptorFito', 'action' => 'export'], ['pass' => ['idx', 'idy']]);
