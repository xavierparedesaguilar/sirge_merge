...
function tablaListadoDataTable_ajax(id_tabla)
{
	...
	$('#tablaListado').on('click', '.delete-btn', function (e) {
		e.preventDefault();
		$("#ajax_button").html("<a  href='"+ CK.base_url + 'admin/fitogenetico/datos-pasaporte/eliminar/' + $(this).attr("data-id")+"' class='btn btn-success btn-flat btnEliminar'><i class='fa fa-check' aria-hidden='true'></i> Confirmar</a>");
		$("#trigger").click();
	}); 
...
$('#view').on('click', '.view-btn', function (e) {
    alert('view')
    // e.preventDefault();
    // // $("#ajax_button").html("<a  href='"+ CK.base_url + 'admin/fitogenetico/datos-pasaporte/eliminar/' + $(this).attr("data-id")+"' class='btn btn-success btn-flat btnEliminar'><i class='fa fa-check' aria-hidden='true'></i> Confirmar</a>");
    // $("#view").click();
    ...
    if($('#tablaListado').length>0) {
        ...
        if(countLista>0){
            ...
            $.each(data, function( index, value ) {
             ...
             var titulo='Lista de Descriptores';
             ...
             $.ajax({
                ...
                success: function (data) {
                    if(data.msj == 'ok'){
                        $("#exportar").modal('show');
                        $("#mensaje").html('<h4>¿Desea descargar el reporte?</h4>');
...
$(document).on('click', "#btnChangeClave", function () {
   ...
   }, "La Contraseña debe tener un número y una mayúscula como mínimo.");
    ...
    $("#form_change_password").validate({
      ...
      messages: {
        password: {
            required: "Debe ingresar la Contraserña nueva.",
...
$(document).on('click', "#btnEstacion", function () {
   ...
   $("#form_station").validate({
    ...
    messages: {
        ...
        email: {
            required : "Email es un campo requerido-2.",
            email    : "Ingrese e-mail válido.",
            remote   : jQuery.validator.format("E-mail ya existe."),
...
$(document).on('click', "#btnFenotipica", function () {
    $("#form_fenotipica").validate({
        ...
        messages: {
            coleccion_id_: "Colección es un campo requerido.",
            especie_id: "Nombre Científico es un campo requerido.",
        },
        messages: {
...
$(document).on('click', "#btnBankInvitro", function () {
    ...
    $("#form_bankInvitro").validate({
        ...
        messages: {
            fecha_aquisicion: {
                required: "Ingresar Fecha de Introducción.",                    
            },
            shelving: {
                required: "Ingresar Ubicación.",                    
            },
            levelshelv: {
                required: "Ingresar Nivel de Estandería.",
                number: "Solo se permiten números.",
            ...
            rack: {
                required: "Ingresar número de la Gradilla.",
                number: "Solo se permiten números.",
            ...
            explnumb: {
                required: "Ingresar número de Explantes.",
                number: "Solo se permiten números.",
                maxlength: "Número de Explantes tiene un máximo de 9 caracteres.",                    
            },
            tubenumb: {
                number: "Solo se permiten números.",
                required: "Ingresar la cantidad de Tubos.",
                maxlength: "Nivel Estantería tiene un máximo de 9 caracteres.",
            },
            pasaporte:{
                required: "Código PER es un campo requerido.",
            ...
            responsible:{
                required: "Ingresar el Nombre del Responsable.",
            },
            origin:{
                required: "Propcedencia del Material.",
            },
            storoom:{
                required: "Seleccione el Cuarto de Conservación.",
            },
            temp:{
                required: "Seleccionar Temperatura.",
            },
            storage:{
                required: "Seleccione el Tipo de Medio.",
            },
            tubesize:{
...
/****************** INICIO DE VALIDACION PROPAGACIÓN DE MATERIAL*********************/
$(document).on('click', "#btnPropagationInvitro", function () {
        ...
        $("#form_propagationInvitro").validate({
            ...
            messages: {
                propagator:{
                    required: "Ingresar Nombre del Propagador.",
                },
                ...
                proinicial:{
                    required: "Ingresar Inicales del Propagador.",
                },
...
/****************** INICIO DE VALIDACION CONSERVACIÓN DE MATERIAL *******************/
$(document).on('click', "#btnConservationInvitro", function () {
    ...
    $("#form_conservationInvitro").validate({
        ...
        messages: {
            ...
            fecha_conservacion:{
                required: "Ingresar Fecha de Conservación.",
            },
            consresponsible:{
                required: "Ingresar Nombre del Responsable .",
            },
            ...
            stoper:{
                required: "Ingresar Periodo de Conservación.",
            },
...
$(document).on('click', "#btnInputInvitro", function () {
    ...
    $("#form_inputInvitro").validate({
            ...
            messages: {
                ...
                donorname:{
                    required: "Ingresar Nombre del Donante.",
                },
                fecha_entrada:{
                    required: "Ingresar de Entrada de Material.",
                },

                tubentnumb:{
                    required: "Ingresar cantidad de Muestras.",
                    number: "Solo se permiten números.",

                },
                explentnumb:{
                    required: "Ingresar cantidad de Explantes.",
                    number: "Solo se permiten números.",
                }
            },
            submitHandler: function (form) {
...
/****************** INICIO DE VALIDACION SALIDA DE MATERIAL *************************/
$(document).on('click', "#btnOutputInvitro", function () {
    ...
    $("#form_outputInvitro").validate({
        ...
        messages: {
            ...
            fecha_salida:{
                required: "Ingresar Fecha Salida del Material.",
            },
            tubexitnumb:{
                required: "Ingresar cantidad de Material.",
                number: "Solo se permiten números.",
                // maxlength: "Ingrese como máximo un numero de 9 dígitos",
            },
            explexitnumb:{
                required: "Ingresar cantidad de Exsplantes.",
                number: "Solo se permiten números.",
                // maxlength: "Ingrese como máximo un numero de 9 dígitos",
            },
...
/****************** INICIO DE VALIDACION DE CARGA DE BANKINVITRO **********************/
$(document).on('click', "#btnImportBankInitro", function () {

    $("#form_import_bankinvitro").validate({
...
//********************** EFECTO AL CARGAR BANKINVITRO **********************//
$(document).on('click', "#btnCargarBankInvitro", function () {
    $("#form_cargar_bankinvitro").validate({
        ignore : [],
        errorClass: 'myErrorClass',
        errorElement: "span",
        rules: {
        ...
        submitHandler: function (form) {
            $('#btnCargarBankInvitro').attr("disabled", true);
            $("#carga").css("display","block");
            $("#carga_bankinvitro").css("display","block");
            form.submit();
        },
    });
});
...
/****************** INICIO DE VALIDACION DE CARGA DE BANKSEED **********************/
$(document).on('click', "#btnImportBankSeed", function () {

    $("#form_import_bankseed").validate({
        ...
        messages: {
            file_cargas: "Debe seleccionar un archivo.",
        },
        submitHandler: function (form) {
            console.log("enviando_data_form_:");
            $('#btnImportBankSeed').attr("disabled", true);
            $("#carga").css("display","block");
            form.submit();
        },
        highlight: function (element, errorClass, validClass) {
