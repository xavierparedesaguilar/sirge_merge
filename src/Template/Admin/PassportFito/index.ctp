        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success">
                <div class="panel-heading box-header with-border box-title">
                    <h4><i class="fa fa-list-alt" aria-hidden="true""></i> Registro Datos Pasaporte </h4>
                    <div class="pull-right box-tools">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-cloud-upload" ></i>',
                                    ...
                                    ['class' => 'btn btn-warning', 'data-toggle'=> "tooltip",  'title'=> "Importar Regsitro", 'escape'=>false] )
                        ?>
                        ...
                        <?php if($permiso['export']) { ?>
                             ...
                             <button type="submit" data-toggle="tooltip"  title="Exportar Registro" id="export" class="btn btn-info waves-effect m-r-5" >
