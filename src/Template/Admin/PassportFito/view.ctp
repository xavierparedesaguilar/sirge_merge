        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
          <div class="panel panel-default box box-success"> 
                <div class="panel-heading box-header with-border">
                    <h4><i class="fa fa-search"></i> <?= __('Detalle de Registro Dato Pasaporte') ?>: <strong> <?php echo $passportFito->passport->accenumb ?></strong></h4>
                              ...
                              <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6">
                                      <div class="row">
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                              <h3 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Código de Asignación Internacional del Instituto por la FAO</h3>
                                            </div>
                                      ...
                                      <div class="row">
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                              <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Principal</h4>
                                            </div>
                                            <div class="table-responsive">  
                                             <table class="table table-striped table-bordered table-hover">
                                                 <!-- DATOS PRINCIPALES -->                         
                                    ...
                                    <div class="col-xs-12 col-md-6 col-lg-6">
                                        <div class="row">
                                         <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                              <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> EEA de Conservación y Procedencia</h4>
                                            </div>
                                            <div class="table-responsive">  
                                             <table class="table table-striped table-bordered table-hover">
                                                    <tr>
                                        ...
                                        <div class="row">
                                          <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                              <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Adicional</h4>
                                            </div>
                                            <div class="table-responsive"> 
                                                <table class="table table-striped table-bordered table-hover">
                                                        <tr>
                        ...
                        <div class="box box-success box-solid">                            
                            <div class="box-body">
                              <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="box-header with-border">
                                             <h3 class="box-title"><strong><i class="fa fa-map-marker"></i> DATOS DE UBICACIÓN</strong></h3>
                                        </div>
                                    </div>
                              </div>
                              <div class="row">
                        ...
                        <div class="box box-success box-solid">                            
                            <div class="box-body">
                              <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="box-header with-border">
                                             <h3 class="box-title"><strong><i class="fa fa-file-text-o"></i> DATOS DE COLECTA</strong></h3>
                                        </div>
                                    </div>
                              </div>
                              <div class="row">
              ...
              <div class="col-xs-12 col-md-12 col-lg-12">
                        <div class="box box-success box-solid">                            
                            ...
                            <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="box-header with-border">
                                             <h3 class="box-title"><strong><i class="fa fa-cloud"></i> DATOS ECOGEOGRÁFICOS</strong></h3>
                                        </div>
                                    </div>
                              </div>
                              <div class="row">
                                    <div class="col-xs-12 col-md-6 col-lg-6">
                                      <div class="row">
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                              <h3 class="box-title">
                                              <i class="fa fa-thermometer-quarter"></i> Información de las Condiciones Climáticas</h3>
                                            </div>
                                            <div class="table-responsive">  
                                             <table class="table table-striped table-bordered table-hover">
                                                 <tr>
                        ...
                        <div class="box box-success box-solid">                            
                            <div class="box-body">
                              <div class="row">
                                    <div class="col-xs-12 col-md-12 col-lg-12">
                                        <div class="box-header with-border">
                                             <h3 class="box-title"><strong><i class="fa fa-ge"></i> DATOS ADICIONALES</strong></h3>
                                        </div>
                                    </div>
                              </div>
                              <div class="row">
