        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
          <div class="panel panel-default box box-success">
                 <div class="panel-heading box-header with-border">
                    <h4><i class="fa fa-pencil-square-o"></i> <?= __('Actualización de Registro Datos Pasaporte:') ?><strong> <?= $passport->accenumb?></strong></h4>
        ...
        <div class="box-body">
            ...
            <div id="tabla1" class="tab-pane active">
                          <div class="row">  
                            <div class="col-lg-6">
                             <?php echo $this->Form->control('passport_validation', ['type' => 'hidden', 'value' => $passpor_validation['validation'] ]) ?>
                                ...
                                <div class="row">  
                                    <div class="col-lg-12">                                     
                                         <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Código de Asignación Internacional del Instituto<hr></h4>
                                  </div>
                             ...
                             <div class="col-lg-6">
                               <div class="row">
                                 <div class="col-lg-12">                                   
                                         <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Estación Experimental de Conservación y Procedencia<hr></h4>
                                </div>
                          ...
                          <div class="row">  
                            <div class="col-lg-6">
                            <div class="row">  
                              <div class="col-lg-12"><h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Principal<hr></h4></div>
                            </div>
                             <div class="row">  
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row">  
                             ...
                             <div class="col-lg-6">
                               <div class="row"> 
                                   <div class="col-lg-12">
                                     <h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Adicional<hr></h4>
                                   </div>
                               </div>
                               <div class="row"> 
                                    <div class="col-lg-6 col-sm-12 col-xs-12">
                             ...
                             <div class="col-lg-6">
                               <div class="row"> 
                                   <div class="col-lg-12">
                                     <h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Accesión Promisoria y Disponibilidad<hr></h4>
                                   </div>
                               </div>
                                <div class="row"> 
                                   <div class="col-lg-6 col-sm-12 col-xs-12">
                 ...
                 <div class="row">  
                    <div class="col-lg-12">
                            <div class="row">  
                              <div class="col-lg-12"><h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Información de la Colecta<hr></h4></div>
                            </div>
                            <div class="row">  
              ...
              <div class="row">                      
                 ...
                 <div class="row">  
                            <div class="col-lg-6">                            
                                <div class="row">  
                                    <div class="col-lg-12">                                     
                                         <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Ancestral de la Accesión<hr></h4>
                                    </div>
                                </div>
                                <div class="row">  
                                    <div class="col-lg-6 col-sm-12 col-xs-12">
                             ...
                             <div class="col-lg-6">
                               <div class="row">
                                 <div class="col-lg-12">                                   
                                         <h4 class="box-title"><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Adicional<hr></h4>
                                 </div>
                               </div>
                               <div class="row">  
                          ...
                          <div class="col-lg-6">                            
                              <div class="row">  
                                <div class="col-lg-12"><h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Información Legal<hr></h4></div>
                              </div>
                            <div class="row">  
                                    <div class="col-lg-4 col-sm-12 col-xs-12">
                          ...
                          <div class="col-lg-6">                            
                                <div class="row"> 
                                   <div class="col-lg-12">
                                     <h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Lugares de Almacenamiento donde se encuentra la Accesión<hr></h4>
                                   </div>
                               </div>
                               <div class="row"> 
                                    <div class="col-lg-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-12">
                               <div class="row"> 
                                   <div class="col-lg-12">
                                     <h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Observaciones o Anotaciones<hr></h4>
                                   </div>
                               </div>
                               <div class="row"> 
