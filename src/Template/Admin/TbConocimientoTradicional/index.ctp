...
<section class="content-header">
   ...
   <?php echo($Zabd->nombre)?>
    ...
    $this->Html->addCrumb($Zabd->cod_zabd, ['controller' => 'TbConocimientoTradicional', 'action' => 'index', 'idx' => $Zabd->id]);
            ...
            <div class="box box-success">
                ...
                <?php echo $this->Html->link(
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbConocimientoTradicional', 'action' => 'add', 'idx' => $Zabd->id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <!-- <th style="min-width: 200px;">CULTIVOS</th> -->
                                    <!-- <th style="min-width: 200px;">CONOCIMIENTOS EMPLEADOS</th> -->
                                    <th style="min-width: 200px;">NOMBRE TRADICIONAL DEL CONOCIMIENTO</th>
                                    <th style="min-width: 140px">ÁREA</th>
                                    <th style="min-width: 120px">ACCIÓN</th>
                                    <!-- <th style="min-width: 120px">ETAPAS</th> -->
                            ...
                            <tbody>
                                <?php foreach ($TbConocimientoTradicional as $rs) :
                                ?>
                                    <tr>
                                        <td><?= $this->Number->format($rs->id) ?></td>
                                        <!-- <td>< ?php echo $rs->numero_correlativo ?></td> -->

                                        <!-- <td>< ?= h($rs->tb_cultivo_conocimiento['tb_cultivo']['cultivo']) ?></td> -->
                                        <!-- <td>< ?= h($conocimiento_id) ?></td> -->

                                        <td><?= h($rs->nombre_tradicional_conocimiento) ?></td>
                                        <td><?= h($rs->tb_sector->sector) ?></td>
                                        <td><?= h($rs->tb_metodo->metodo) ?></td>

                                        <!-- <td>< ?= h($rs->tb_etapa_conocimiento['tb_etapa']['etapa']) ?></td> -->

                                        <td><?php echo $rs->descripcion ?></td>
                                        <td class="text-center">
                                            <?php if ($permiso['view']) { ?>
                                                <?php echo $this->Html->link('<i class="fa fa-search-plus"></i>',
                                                ['controller' => 'TbConocimientoTradicional', 'action' => 'view', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
                                        ...
                                        ?>
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbConocimientoTradicional', 'action' => 'edit', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
