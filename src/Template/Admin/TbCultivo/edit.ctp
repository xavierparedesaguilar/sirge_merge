...
<section class="content-header">
    ...
    $this->Html->addCrumb("$mod_title", ['controller' => 'TbCultivo', 'action' => 'index', 'idx' => $Idx,'id'=>$Id]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <?php echo $this->Html->link(
                        ...
                        ['controller' => 'TbCultivo', 'action' => 'index', 'idx' => $Idx, 'id'=>$Id],
                ...
                <?php echo $this->Form->create($TbCultivo, [
                    // 'url' => ['controller' => 'TbCultivo', 'action' => 'edit', 'idx' => $Idx, 'id'=> $Id],
                    'autocomplete' => "off",
                    'id' => "form_Zabd_accesi"
                ]); ?>
    <!-- < ?php var_dump("olisssss"); exit;   ?> -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-6">
                                            <div class="box box-success">
                                                ...
                                                <div class="box-body">
                                                    <?php echo $this->Form->control('cultivo', [
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        ...
                        <?php echo $this->Html->link('CANCELAR', ['controller' => 'TbCultivo', 'action' => 'index', 'idx' => $Idx, 'id'=>$Id], ['class' => 'btn btn-default',]) ?>
                    </div>
                </div>
                <?= $this->Form->end() ?>
            </div>
