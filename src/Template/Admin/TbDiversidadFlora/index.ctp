...
<section class="content-header">
    ...
    $this->Html->addCrumb($Zabd->cod_zabd, ['controller' => 'TbDiversidadFlora', 'action' => 'index', 'idx' => $Zabd->id]);
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbDiversidadFlora', 'action' => 'add', 'idx' => $Zabd->id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php foreach ($TbDiversidadFlora as $rs) :
                                ?>
                                    <tr>
                                        <td><?= $rs->id ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($permiso['view']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadFlora', 'action' => 'view', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadFlora', 'action' => 'edit', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
