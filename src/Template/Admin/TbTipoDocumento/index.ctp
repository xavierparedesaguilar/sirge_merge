        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Html->link(
                        ...
                        ['controller' => 'TbTramiteDocumentario', 'action' => 'index', 'idx' => $id_zabd],
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbTipoDocumento', 'action' => 'add', 'idx' => $id_zabd], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php foreach ($TbTipoDocumento as $rs) : ?>
                                    <tr>
                                        <td>
                                            <?= $this->Number->format($rs->id) ?>
                                        </td>
                                        <td>
                                            <?php echo $rs->tipo_documento ?>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <?php if ($permiso['view']) { ?>
                                                <!-- < ?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbTipoDocumento', 'action' => 'view', 'idx' => $id_zabd,'id' => $rs->id ],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbTipoDocumento', 'action' => 'edit', 'id' => $rs->id, 'idx' => $id_zabd],
