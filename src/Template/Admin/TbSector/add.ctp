    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($TbSector, [
                    'url' => ['controller' => 'TbSector', 'action' => 'add','idx'=>$id_zabd],
                    'autocomplete' => "off",
                    'id' => "form_Zabd_accesi"
                ]); ?>
                <div class="box-body">
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-6">
                                            <div class="box box-success">
                                                <div class="box-header with-border">
                                                    <h3 class="box-title">Datos de sector o área</h3>
                                                </div>
                                                <div class="box-body">
                                                    <?php echo $this->Form->control('sector', [
                                                        'label' => 'Nombre la sector o área <b style="color:#dd4b39;">(*)</b>', 'escape' => false,
                                                        'class' => 'form-control',
                                                    ]); ?>
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <!-- < ?php echo $this->Form->button('GRABAR',['class'=>'btn btn-success', 'id'=>'btnTbSector']) ?> -->
                        <?php echo $this->Form->button('GRABAR', ['class' => 'btn btn-success', 'id' => 'btnInsituAccesion']) ?>

                        <?php echo $this->Html->link('CANCELAR', ['controller' => 'TbSector', 'action' => 'index','idx'=>$id_zabd], ['class' => 'btn btn-default',]) ?>
                    </div>
                </div>
                <?= $this->Form->end() ?>
            </div>
