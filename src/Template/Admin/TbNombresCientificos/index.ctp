                ...
                <!-- < ?php echo $this->Html->link(
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbNombresCientificos', 'action' => 'add','idx'=>$Idx, 'id' => $Id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                            <tbody>
                                <?php foreach ($TbNombresCientificos as $rs) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <!-- < ?php if ($permiso['view']) { ?>
                                                < ?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbNombresCientificos', 'action' => 'view', 'idx' => $Idx,'id' => $rs->id ],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbNombresCientificos', 'action' => 'edit', 'idx' => $Idx, 'id' => $Id, 'idy'=>$rs->id],
