            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbMetodo', 'action' => 'add', 'idx' => $id_zabd], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 120px">METODO</th>
                                        ...
                                        <td class="text-center">
                                            <?php if ($permiso['view']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbMetodo', 'action' => 'view', 'idx' => $id_zabd,'id' => $rs->id ],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbMetodo', 'action' => 'edit', 'id' => $rs->id, 'idx' => $id_zabd],
