...
<section class="content-header">
    <h1><i class="fa fa-desktop" aria-hidden="true"></i> Sistema de Información de Recursos Genéticos - SIRGE</h1>
    ...
    <ol class="breadcrumb">
        ...
        <?php foreach ($this->Functions->generate_nav() as $key => $value): ?>
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    <li>
                        <a href="<?php echo $this->Url->build('/'.$temp_url, true) ?>"><?php echo $value ?>-1</a>
                    </li>
                <?php endif ?>
            <?php endif ?>
            <?php $i++; ?>
