        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($TbTramiteDocumentario, [
                    'url' => ['controller' => 'TbTramiteDocumentario', 'action' => 'add', 'idx' => $Zabd->id],
                    'autocomplete' => "off",
                    'id' => "form_Zabd_accesi"
                ]); ?>
                <div class="box-body">
...
// $this->Html->scriptBlock('$("#fecha-salidas").datepicker({autoclose: true,todayHighlight: true, language: "es", format: "dd-mm-yyyy"});', ['block' => true]);
// $this->Html->scriptBlock('$("#fecha-ingresos").datepicker({autoclose: true,todayHighlight: true, language: "es", format: "dd-mm-yyyy"});', ['block' => true]);
