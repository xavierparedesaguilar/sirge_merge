        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success"> 
                <div class=" panel-heading box-header with-border">
                    <h4><i class="fa fa-search"></i> <?= __('Detalle del Registro - Inventario') ?>:<strong><?php echo$bankSeed->codaccesion->accenumb?> - LOTE <?php echo$bankSeed->lotnumb ?></strong></h4>
                                                    ...
                                                    <div class="table-responsive">  
                                                        <table class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td scope="row"><?= h($bankSeed->codaccesion->especiesemilla->colecction->colname) ?></td>
                                                            </tr>
                                                            <tr>
