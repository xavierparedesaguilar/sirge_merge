        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success"> 
                <div class="panel-heading box-header with-border">
                        <h4><i class="fa fa-file-text-o" aria-hidden="true"></i> Nuevo Registro - Inventario</h4>
                ...
                <div class="box-footer">
                      ...
                      <div class="col-sm-8 text-right">
                        ...
                        <button type="submit" class="btn btn-success" id="btnBankSeed"> <i class="fa fa-save"></i> GUARDAR REGISTRO</button>
                      </div>
                </div>
                <?= $this->Form->end() ?>
            </div>
