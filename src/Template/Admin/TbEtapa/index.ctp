                ...
                <?php echo $this->Html->link(
                    ...
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            ...
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbEtapa', 'action' => 'add','idx'=>$Idx, 'id' => $Id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                                        ...
                                        <td class="text-center">
                                            <!-- < ?php if ($permiso['view']) { ?>
                                                < ?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbEtapa', 'action' => 'view', 'idx' => $Idx,'id' => $rs->id ],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbEtapa', 'action' => 'edit', 'idx' => $Idx, 'id' => $Id, 'idy'=>$rs->id],
