    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success"> 
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-4">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <?php echo $this->Html->link('DESCARGAR FORMATO', ['controller' => 'FenotipicaFito', 'action' => 'exportardescriptores'], ['class' => 'btn btn-info', 'data-toggle' => "tooltip", 'escape' => false] ); ?>
                                            </div>                                             
                                        </div>                                     
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                                <h3 class="box-title"><br><i class="fa fa-cloud-download"></i> Lista de Descriptores - Vista Premilinar</h3>
                                            </div>                                        
                               ...
                               <div id="tabla2" class="tab-pane">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-4">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <!-- <a href="<?php echo $this->Url->build('/admin/fitogenetico/datos-pasaporte/exportar') ?>"  class="btn btn-info" >DESCARGAR FORMATO </a> -->
                                                <?php echo $this->Html->link('DESCARGAR FORMATO', ['controller' => 'FenotipicaFito', 'action' => 'exportarestados'], ['class' => 'btn btn-info', 'data-toggle' => "tooltip", 'escape' => false] ); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-12 col-lg-12">
                                            <div class="box-header with-border">
                                                <h3 class="box-title"><br><i class="fa fa-cloud-download"></i> Lista de Estados - Vista Premilinar</h3>
                                            </div>
                ...
                <div class="overlay" id="carga_state_final" style="display: none;"><i class="fa fa-refresh fa-spin"></i></div>
            </div>
        </div>       
    </div>
</div>
