...
<section class="content-header">
    ...
    $this->Html->addCrumb($TbPadronComuneros->id, ['controller' => 'TbPadronComuneros', 'action' => 'edit', 'idx' => $Zabd->id, 'id' => $TbPadronComuneros->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Form->create($TbPadronComuneros, [
                    // 'url' => ['controller' => 'TbPadronComuneros', 'action' => 'edit', 'idx' => $Zabd->id],
                    'autocomplete' => "off",
                    'id' => "form_Zabd_accesi"
                ]); ?>
                <div class="box-body">
                                            ...
                                            <div class="box box-success">
                                                ...
                                                <div class="box-body">
                                                    <?php echo $this->Form->control('departamento', [
                                                        ...
                                                        'default' => $TbPadronComuneros->ubigeo['cod_dep'],
                                                        'empty' => 'Seleccionar...',
                                                    ]); ?>
                                                    ...
                                                    <?php echo $this->Form->control('provincia', [
                                                        ...
                                                        'class' => 'form-control select2',
                                                        'type' => 'select',
                                                        'default' => empty($TbPadronComuneros->ubigeo_id) ? '' : $TbPadronComuneros->ubigeo->cod_pro,
                                                        'empty' => ['0' => 'Seleccionar...']
                                                    ]) ?>
                                                    ...
                                                    <?php echo $this->Form->control('distrito', [
                                                        ...
                                                        'class' => 'form-control select2',
                                                        'type' => 'select',
                                                        'default'  => $TbPadronComuneros->ubigeo_id,
                                                        'empty' => ['0' => 'Seleccionar...'],
                                                    ]) ?>
