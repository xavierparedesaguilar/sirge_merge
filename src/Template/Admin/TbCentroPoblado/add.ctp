            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <?php echo $this->Html->link(
                        ...
                        ['controller' => 'TbCentroPoblado', 'action' => 'index', 'idx' => $idComunidad, 'id'=>$idCentroPoblado],
                ...
                <?php echo $this->Form->create($TbCentroPoblado, [
                    'url' => ['controller' => 'TbCentroPoblado', 'action' => 'add', 'idx' => $idComunidad, 'id'=> $idCentroPoblado],
                    'autocomplete' => "off",
                    'id' => "form_Zabd_accesi"
                ]); ?>
                <div class="box-body">
