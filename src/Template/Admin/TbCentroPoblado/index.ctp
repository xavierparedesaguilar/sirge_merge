...
<section class="content-header">
    <h1>Módulo
        <?php echo $mod_modulo . ' - ' . $mod_title . ' - ' . $nombre_comunidad; ?>
    </h1>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Html->link(
                        ...
                        ['controller' => 'TbComunidad', 'action' => 'index', 'idx' => $idComunidad],
                        ['class' => 'btn  btn-default', 'data-toggle' => "tooltip", 'title' => "Regresar", 'escape' => false]
                    )
                    ?>
                    <h3 class="box-title"><strong>Registro de
                            <?php echo $mod_title .' - ' . $nombre_comunidad?>

                        </strong></h3>
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>

                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbCentroPoblado', 'action' => 'add','idx'=>$idComunidad, 'id' => $idCentroPoblado], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                            <tbody>
                                <?php foreach ($TbCentroPoblado as $rs) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <!-- < ?php if ($permiso['view']) { ?>
                                                < ?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbCentroPoblado', 'action' => 'view', 'idx' => $idComunidad,'id' => $rs->id ],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbCentroPoblado', 'action' => 'edit', 'idx' => $idComunidad, 'id' => $idCentroPoblado, 'idy'=>$rs->id],
...
<div class="modal fade" id="exportar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create(NULL, ['url' => ['action' => 'exportartabla', 'idx' => $idComunidad, 'id'=>$idCentroPoblado]]); ?>
            <div class="modal-body">
                <p id="mensaje"></p>
