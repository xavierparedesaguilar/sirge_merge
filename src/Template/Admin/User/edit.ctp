        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success"> 
                <div class="panel-heading ">
                    <h4><i class="fa fa-user-circle-o" aria-hidden="true"></i>  Actualización de Registro - Usuario: <strong><?php echo $user->username;?><strong></h4>
                </div>
                ...
                <div class="box-body">                                                               
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <?php echo $this->Form->control('names', [
                                            'label' => ['text' => 'Nombres <b style="color:#dd4b39;">(*)</b>',  'escape' => false],
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <?php echo $this->Form->control('email', [
                                            'label' => ['text' => 'Correo Electrónico <b style="color:#dd4b39;">(*)</b>', 'escape'=> false , 'escape' => false],
                                            'class' => 'form-control',
                                    ]); ?>  
                           </div>  
                           <div class="col-lg-6 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12">
								...
								?>
									...
									>
								Permitir al Usuario acceso a la información de todas las Estaciones Experimentales
								</label>
                    ...
                    <div class="col-lg-12"><h4><i class="fa fa-toggle-on" aria-hidden="true"></i> Lista de opciones para acceso a los módulos del SIRGE</h4></div>
                    <div class="col-xs-12 col-md-12 col-lg-12">
