                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <center>
                                            <span>
                                                <strong>
                                                    ...
                                                    <?php echo $this->Html->link(h($bankInvitro->lotnumb),
                                    ...
                                    <td><em><?php echo $bankInvitro->passport->specie->genus.' '.$bankInvitro->passport->specie->species  ?></em> <?php echo $bankInvitro->passport->specie->autor?></td>
                                    <td><?php echo $bankInvitro->passport->specie->cropname?></td>
                                    <td><center><?php echo ($bankInvitro->acqdate == NULL || $bankInvitro->acqdate=='')? '' : date("d-m-Y", strtotime($bankInvitro->acqdate))  ?></center></td>
                                    <td><?php echo h($bankInvitro->conservacion->name)?></td>   
                                    <td ><center><strong><?php echo h($bankInvitro->shelving).' - '.h($bankInvitro->levelshelv).' - '.h($bankInvitro->rack)?></strong></center></td>
                                    <td><center>
                                             <strong>                                            
                                                <?php 
                                                    $contenedor=$bankInvitro->tubenumb;
                                                    if($contenedor!=''){
                                    ...
                                    <td><center><?php echo ($this->Number->format($bankInvitro->availability) == 331) ? 'SI' : 'NO' ?></center></td>
                                    <td><center>
                                    <?php
                                    ...
                                    /*$validar=$permiso['role_id']==1?true:$permiso['station_id']==$bankInvitro->passport->station_current_id;*/
                                     ...
                                     ?>
                                        ...
                                        <?php echo $this->Html->link('<i class="fa  fa-sign-in"></i>',
                                                                            ...
                                                                            ['class' => 'btn btn-success btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Entrada de Material."])
                                                                    ?>


                                         <?php echo $this->Html->link('<i class="fa  fa-sign-out"></i>',
                                                                            ['controller' => 'outputInvitro', 'action' => 'index', $bankInvitro->id],
                                                                            ['class' => 'btn btn-warning btn-xs', 'escape' => false, 'data-toggle' => "tooltip", 'title' => "Salida de Material."])
                                                                    ?>
                                        ...
                                        <?php  if($permiso['delete'] /*&& $validar*/) {?>
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-trash-o"></i>', "#",
                                                                                ['class' => 'btn btn-danger btn-xs delete-btn', 'escape' => false, "data-id"=>$bankInvitro->id, 'data-toggle' => "tooltip", 'title' => "Eliminar Registro."])
                                            ?>
