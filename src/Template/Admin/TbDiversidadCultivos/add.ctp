                                            ...
                                            <div class="box box-success">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <?php echo $this->Form->control('nombre_local', [
                                                        // 'label' => 'Escriba el Nombre local del cultivo <b style="color:#dd4b39;">(*)</b>',
