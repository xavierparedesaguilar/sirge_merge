...
<section class="content-header">
    ...
    $this->Html->addCrumb($Zabd->cod_zabd, ['controller' => 'TbDiversidadCultivos', 'action' => 'index', 'idx' => $Zabd->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    ?>
                    <h3 class="box-title"> <strong> | Tabla de registros | </strong> <?php echo ($mod_title) ?></h3>
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbDiversidadCultivos', 'action' => 'add', 'idx' => $Zabd->id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Agregar $mod_title", 'escape' => false]); ?>
                        <?php } ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 120px">PARIENTES SILVESTRES</th>
                            ...
                            <tbody>
                                <?php foreach ($TbDiversidadCultivos as $rs) :
                                ?>
                                    <tr>
                                        <td><?= $rs->id ?></td>
                                        <td><?= h($rs->tb_centro_poblado->centro_poblado) ?></td>
                                        <td><?= h($rs->tb_cultivo->cultivo) ?></td>
                                        <td><?= h($rs->tb_variedade->variedad) ?></td>
                                        <td><?= h($rs->tb_parientes_silvestre->pariente_silvestre) ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($permiso['view']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadCultivos', 'action' => 'view', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadCultivos', 'action' => 'edit', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
