...
<script>
    ...
    $(".delete-btn").click(function(){
        $("#ajax_button").html('<?php echo $this->Html->link('Confirmar', ['controller' => 'OutputInvitro', 'action' => 'delete','id'=> $outputInvitro->bank_invitro_id,'child'=> $outputInvitro->id],  ['class' => 'btn btn-success','escape'=>false] )  ?>');
        $("#trigger").click();
    });
</script>
