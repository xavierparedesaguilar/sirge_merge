        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                ...
                <?php echo $this->Html->link(
                        ...
                        ['controller' => 'TbDiversidadFauna', 'action' => 'index', 'idx' => $Zabd->id],
                        ['class' => 'btn  btn-default', 'data-toggle' => "tooltip", 'title' => "Regresar", 'escape' => false]
                    )
                    ?>
                <h3 class="box-title">  <strong> | Editar registro | </strong> <?php echo ($mod_title) ?></h3>
                </div>
                <?php echo $this->Form->create($TbDiversidadFauna, [
                    // 'url' => ['controller' => 'TbDiversidadFauna', 'action' => 'add', 'idx' => $Zabd->id],
                    'autocomplete' => "off",
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-12 col-lg-6">
                                            <div class="box box-success">
                                                <div class="box-header with-border">
                                                    <h3 class="box-title">Información de diversidad de fauna</h3>
                                                </div>
                                                <div class="box-body">
                                                    ...
                                                    <?php echo $this->Form->control('tb_clase_id', [
                                                        ...
                                                        //  . $this->Html->link(" +", ["controller" => "TbClase", "action" => "index", "idx" => $Zabd->id, 'id' => 0], ["class" => "btn btn-default",  'escape' => false, 'data-toggle' => "tooltip", 'title' => "Se dirigirá a la tabla de Faunas."]),
                                                        'escape' => false,
                                                        'class' => 'form-control',
                                                        'options' => $TbClase,
                                                    ...
                                                    <?php echo $this->Form->control('nombre_local', [
                                                        ...
                                                        'label' => 'Nombre local '.'<i class="fa fa-info-circle" data-toggle="tooltip" title="Campo obligatorio" style="color:#dd4b39;"></i>',
                                                        'escape' => false,
                                                        'class' => 'form-control',
                ...
                <div class="box-footer">
                    <div class="col-sm-12 text-center">
                        <?php echo $this->Form->button('GRABAR', ['class' => 'btn btn-success', 'id' => 'btnTbDiversidadFauna']) ?>
                        <?php echo $this->Html->link('CANCELAR', ['controller' => 'TbDiversidadFauna', 'action' => 'index', 'idx' => $Zabd->id], ['class' => 'btn btn-default',]) ?>
