...
<section class="content-header">
    ...
    $this->Html->addCrumb($Zabd->cod_zabd, ['controller' => 'TbDiversidadFauna', 'action' => 'index', 'idx' => $Zabd->id]);
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="display: none;"> <strong> Registro de <?php echo ($mod_title) ?></strong></h3>
                    <div class="pull-right box-tools">
                        <?php if ($permiso['add']) { ?>
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i>', ['controller' => 'TbDiversidadFauna', 'action' => 'add', 'idx' => $Zabd->id], ['class' => 'btn btn-success', 'data-toggle' => "tooltip", 'title' => "Nuevo registro", 'escape' => false]); ?>
                        <?php } ?>
                        ...
                        <table id="tablaListado" class="table table-striped table-bordered table-hover">
                            <thead class="headTablaListado">
                                <tr class="text-uppercase text-center th-head-inputs">
                                    ...
                                    <th style="min-width: 140px">clase</th>
                            ...
                            <tbody>
                                <?php foreach ($TbDiversidadFauna as $rs) :
                                ?>
                                    <tr>
                                        <td><?= $rs->id ?></td>
                                        <td><?= h($rs->tb_centro_poblado->centro_poblado) ?></td>
                                        <td><?= h($rs->tb_clase->clase) ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($permiso['view']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadFauna', 'action' => 'view', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
                                            ...
                                            <?php if ($permiso['edit']) { ?>
                                                <?php echo $this->Html->link(
                                                    ...
                                                    ['controller' => 'TbDiversidadFauna', 'action' => 'edit', 'id' => $rs->id, 'idx' => $rs->tb_zabd_id],
