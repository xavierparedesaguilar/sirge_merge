...
<script>
    ...
    $(".delete-btn").click(function(){
        $("#ajax_button").html('<?php echo $this->Html->link('Confirmar', ['controller' => 'InputInvitro', 'action' => 'delete','id'=> $inputInvitro->bank_invitro_id,'child'=> $inputInvitro->id], ['class' => 'btn btn-success', 'escape'=>false] ) ?>');
        $("#trigger").click();
    });
</script>
