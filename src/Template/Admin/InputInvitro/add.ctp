        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
            <div class="panel panel-default box box-success"> 
                <div class="panel-heading box-header with-border ">
                    <h4><i class="fa fa-file-text-o" aria-hidden="true"></i> Nuevo Registro de Entrada de Material</h4>
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <?php echo $this->Form->control('donorname', [
                                         'label' => ['text' => 'Nombre del Donante <b style="color:#dd4b39;">(*)</b>' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Nombre del Donante del Material"></i>'],
                                         'escape' => false,
                                         'class' => 'form-control',
                                    ]); ?>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <?php echo $this->Form->control('fecha_entrada', [
                                                        'label' => ['text' => 'Fecha Entrada del Material <b style="color:#dd4b39;">(*)</b>' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Fecha de entrada del material del donante"></i>'],
                                                        'escape' => false,
                                                        'class' => 'form-control'
                                                        // 'readonly' => true
                                     ]); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <?php echo $this->Form->control('tubentnumb', [
                                          'label' => ['text' => 'Número de Tubos de Entrada <b style="color:#dd4b39;">(*)</b>' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Número de tubo que entran de una accesión in vitro"></i>'],
                                          'escape' => false,
                                          'class' => 'form-control',
                                    ]); ?>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <?php echo $this->Form->control('explentnumb', [
                                          'label' => ['text' => 'Número de Explantes de Entrada <b style="color:#dd4b39;">(*)</b>' . ' <i class="fa fa-info-circle" data-toggle="tooltip" title="Número de explantes que entran in vitro de una accesión"></i>'],
                                          'escape' => false,
                                          'class' => 'form-control',
                                    ]); ?>
                                </div>            
