...
class OutputInvitroController extends AppController
{
    ...
    public function index($id = null)
    {
        ...
        if($bankInvitro_count !=NULL && $this->permiso['index']){
            ...
            $outputInvitro = $this->OutputInvitro->find()->where(['OutputInvitro.status !=' => '0', 'bank_invitro_id' => $id])->order(['OutputInvitro.id'=>'DESC']);
            ...
            if ($this->request->is('post')) {
                ...
                try{
                        ...
                        if ($this->OutputInvitro->save($outputInvitro)) {
                            ...
                            $this->Flash->success(__('El Registro fue creado satisfactoriamente.'));
                        ...
                        $data['exitdate'] = ($data['fecha_salida'] == '' || $data['fecha_salida'] == NULL) ? NULL : date('Y-m-d', strtotime($data['fecha_salida']));
                         try{
                                ...
                                if ($this->OutputInvitro->save($outputInvitro)) {
                                    ...
                                    $this->Flash->success(__('El Registro fue actualizada satisfactoriamente.'));
