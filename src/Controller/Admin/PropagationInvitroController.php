...
class PropagationInvitroController extends AppController
{
    ...
    public function index($id = null)
    {
        ...
        if($bankInvitro_count !=NULL && $this->permiso['index']){
            ...
            $propagationInvitro = $this->PropagationInvitro->find()->contain(['BankInvitro'])->where(['PropagationInvitro.status !=' => '0', 'bank_invitro_id' => $id])->order(['PropagationInvitro__id'=>'DESC']);

            // echo"<pre>";
            // print($propagationInvitro);exit;
            // echo"</pre>";
            ...
            if ($this->request->is('post')) {
                ...
                try{
                        ...
                        if ($this->PropagationInvitro->save($propagationInvitro)) {
                            ...
                            $this->Flash->success(__('Resgistro de Datos de Propagación fue ingresado satisfactoriamente.'));

                            return $this->redirect(['action' => 'index', $propagationInvitro->bank_invitro_id]);
                        }
                        $this->Flash->error(__('Hubo inconvenientes al crear el Registros. Por favor, Otra vez intente.'));
                } catch (\Exception $e) {
                    ...
                    if ($this->request->is(['patch', 'post', 'put'])) {
                        ...
                        try{
                                ...
                                if ($this->PropagationInvitro->save($propagationInvitro)) {
                                    ...
                                    $this->Flash->success(__('El Regsitro fue actualizado satisfactoriamente.'));
                ...
                $propagationInvitro['status'] = 0;
                    ...
                    if ($this->PropagationInvitro->delete($propagationInvitro)) {
                        ...
                        $this->Flash->success(__('El Registro fue eliminado satisfactoriamente.'));
                         ...
                         $this->Flash->error(__('Hubo inconvenientes al eliminar el Regsitro . Por favor, Otra vez intente.'));
                    }
