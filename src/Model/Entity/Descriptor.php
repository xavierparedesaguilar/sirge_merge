...
class Descriptor extends Entity
{
    ...
    protected function _getDescriptorState()
    {
        $result = TableRegistry::get('Descriptor_state')->find()->where(['descriptor_id' => $this->_properties['id'], 'status'=>'1'])->order(['code'=>'asc'])->all();
