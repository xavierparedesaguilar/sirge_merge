 ...
 * @property \App\Model\Table\TbCentroPobladosTable|\Cake\ORM\Association\BelongsTo $TbCentroPoblado
 * @property \App\Model\Table\ZabdTable|\Cake\ORM\Association\BelongsTo $Zabd
 *
 * @method \App\Model\Entity\TbDiversidadFlora get($primaryKey, $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\TbDiversidadFlora findOrCreate($search, callable $callback = null, $options = [])
 */
class TbDiversidadFloraTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('tb_diversidad_flora');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('tipo_diversidad')
            ->allowEmpty('tipo_diversidad');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->isUnique(['tb_clase_id','tb_zabd_id','nombre_local','tb_centro_poblado_id',], 'Registro ya existe !'));
