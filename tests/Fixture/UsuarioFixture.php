...
class UsuarioFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombres' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_usuario_rol1_idx' => ['type' => 'index', 'columns' => ['rol_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'estado' => 1,
            'created' => '2017-03-31 22:06:51',
            'modified' => '2017-03-31 22:06:51'
        ],
    ];
}
