...
/**
 * CatalogueCharacterizationFixture
 *
 */
class CatalogueCharacterizationFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'catalogue_characterization';
    ...
    public $fields = [
        ...
        'descriptor_name' => ['type' => 'string', 'length' => 120, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'descriptor_id' => 1,
            'descriptor_name' => 'Lorem ipsum dolor sit amet',
            'resource_id' => 1,
            'collection_id' => 1,
            'specie_id' => 1,
            'availability' => 1,
            'created' => '2017-07-07 15:28:20',
            'modified' => '2017-07-07 15:28:20'
        ],
    ];
}
