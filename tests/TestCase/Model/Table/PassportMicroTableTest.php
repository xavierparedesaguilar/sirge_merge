...
use App\Model\Table\PassportMicroTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PassportMicroTable Test Case
 */
class PassportMicroTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PassportMicroTable
     */
    public $PassportMicro;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PassportMicro') ? [] : ['className' => 'App\Model\Table\PassportMicroTable'];
        $this->PassportMicro = TableRegistry::get('PassportMicro', $config);
    }
