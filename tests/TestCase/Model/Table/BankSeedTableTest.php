...
use App\Model\Table\BankSeedTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\BankSeedTable Test Case
 */
class BankSeedTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\BankSeedTable
     */
    public $BankSeed;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('BankSeed') ? [] : ['className' => 'App\Model\Table\BankSeedTable'];
        $this->BankSeed = TableRegistry::get('BankSeed', $config);
    }
