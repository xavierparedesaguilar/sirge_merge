...
use App\Model\Table\PassportZooTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PassportZooTable Test Case
 */
class PassportZooTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PassportZooTable
     */
    public $PassportZoo;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PassportZoo') ? [] : ['className' => 'App\Model\Table\PassportZooTable'];
        $this->PassportZoo = TableRegistry::get('PassportZoo', $config);
    }
