...
use App\Model\Table\InsituAccesionTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\InsituAccesionTable Test Case
 */
class InsituAccesionTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\InsituAccesionTable
     */
    public $InsituAccesion;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('InsituAccesion') ? [] : ['className' => 'App\Model\Table\InsituAccesionTable'];
        $this->InsituAccesion = TableRegistry::get('InsituAccesion', $config);
    }
